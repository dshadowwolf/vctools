...
static void print_memline(unsigned int addr_start, int line) {
  ...
  mvwprintw(mywin, line+2, 14, "%02X %02X %02X %02X %02X %02X %02X %02X  %02X %02X %02X %02X %02X %02X %02X %02X",
  ...
  mvwprintw(mywin, line+2, 63, "%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c%c",
            GET_BYTE(data[0x00]), GET_BYTE(data[0x01]), GET_BYTE(data[0x02]), GET_BYTE(data[0x03]),
            GET_BYTE(data[0x04]), GET_BYTE(data[0x05]), GET_BYTE(data[0x06]), GET_BYTE(data[0x07]),
            GET_BYTE(data[0x08]), GET_BYTE(data[0x09]), GET_BYTE(data[0x0a]), GET_BYTE(data[0x0b]),
            GET_BYTE(data[0x0c]), GET_BYTE(data[0x0d]), GET_BYTE(data[0x0e]), GET_BYTE(data[0x0f]));
...
void initMemoryWindow(struct bcm2835_emul *emu, char w) {
  which = w;
  emul_copy = emu;
